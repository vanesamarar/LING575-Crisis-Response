...
def compute_bleu(reference_text, candidate_text):
 ...
 # Use smoothing function to handle cases with few n-gram matches
    smoothie = SmoothingFunction().method4

    # Compute BLEU score (cumulative up to 4-grams)
...
print("Azure BLEU score:", compute_bleu(original, azure))
print("Google BLEU score:", compute_bleu(original, google))
print("Copy of Alert BLEU score:", compute_bleu(original, copy))
